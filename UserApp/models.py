...
class FacultyAssignModel(models.Model):
    ...
    assigned_by = models.ForeignKey(UserModel, on_delete=models.CASCADE, null=True, related_name='Manager')
    assigned_to = models.ForeignKey(UserModel, on_delete=models.CASCADE, null=True, related_name='Faculty')
    file = models.ForeignKey(StudentFileModel, on_delete=models.CASCADE)
...
class FacultyAnswerModel(models.Model):
    ...
    faculty = models.ForeignKey(UserModel, on_delete=models.CASCADE)
